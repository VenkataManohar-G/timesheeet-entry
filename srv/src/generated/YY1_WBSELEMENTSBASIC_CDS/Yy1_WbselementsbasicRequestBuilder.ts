 ...
 */
export class Yy1_WbselementsbasicRequestBuilder<
...
> extends RequestBuilder<Yy1_Wbselementsbasic<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Wbselementsbasic<T>, T> {
    return new GetAllRequestBuilder<Yy1_Wbselementsbasic<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Wbselementsbasic<T>, T>(
      this.entityApi,
