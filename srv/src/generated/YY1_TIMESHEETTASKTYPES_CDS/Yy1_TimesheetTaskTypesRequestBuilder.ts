 ...
 */
export class Yy1_TimesheetTaskTypesRequestBuilder<
...
> extends RequestBuilder<Yy1_TimesheetTaskTypes<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_TimesheetTaskTypes<T>, T> {
    return new GetAllRequestBuilder<Yy1_TimesheetTaskTypes<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_TimesheetTaskTypes<T>, T>(
      this.entityApi,
