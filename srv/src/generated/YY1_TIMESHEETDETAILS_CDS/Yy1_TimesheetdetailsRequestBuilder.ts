 ...
 */
export class Yy1_TimesheetdetailsRequestBuilder<
...
> extends RequestBuilder<Yy1_Timesheetdetails<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Timesheetdetails<T>, T> {
    return new GetAllRequestBuilder<Yy1_Timesheetdetails<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Timesheetdetails<T>, T>(
      this.entityApi,
