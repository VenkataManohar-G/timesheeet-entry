 ...
 */
export class Zi_Employee_DetsRequestBuilder<
...
> extends RequestBuilder<Zi_Employee_Dets<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Zi_Employee_Dets<T>, T> {
    return new GetAllRequestBuilder<Zi_Employee_Dets<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Zi_Employee_Dets<T>, T>(this.entityApi, {
      p_email: pEmail
    });
  }
}
