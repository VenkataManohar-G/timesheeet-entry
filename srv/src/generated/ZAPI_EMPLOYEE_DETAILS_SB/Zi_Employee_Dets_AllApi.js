...
exports.Zi_Employee_Dets_AllApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const Zi_Employee_Dets_All_1 = require("./Zi_Employee_Dets_All");
const Zi_Employee_Dets_AllRequestBuilder_1 = require("./Zi_Employee_Dets_AllRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class Zi_Employee_Dets_AllApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Zi_Employee_Dets_All_1.Zi_Employee_Dets_All;
    ...
    requestBuilder() {
        return new Zi_Employee_Dets_AllRequestBuilder_1.Zi_Employee_Dets_AllRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Zi_Employee_Dets_All_1.Zi_Employee_Dets_All, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Zi_Employee_Dets_All_1.Zi_Employee_Dets_All)
            };
        }
        return this._schema;
    }
}
exports.Zi_Employee_Dets_AllApi = Zi_Employee_Dets_AllApi;
//# sourceMappingURL=Zi_Employee_Dets_AllApi.js.map